...
@extends('layout/admin')
    ...
    @endif
    	...
    	<div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">Tambah Kategori</button>
                                        <br><br>
                                        <h4 class="header-title">Input Katalog</h4>

                                    <form action="{{route ('katalog_up')}} " method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="deskripsi" value="" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Harga</label>
                                            <input class="form-control" type="text" name="harga" value="" id="example-text-input">
                                        </div>
                                        <div class="input-group mb-3">
                                                <div class="input-group-prepend">
