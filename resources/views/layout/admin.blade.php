    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{route('landing')}}"><h4>ALUMUNINDO </h4></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="">
                                <a href="{{route ('depan')}}" ><i class="ti-dashboard"></i><span>Halaman Depan</span></a>
                            ...
                            <li class="">
                                <a href="{{route ('about')}}" ><i class="ti-user"></i><span>About</span></a>
